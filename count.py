...
ignoreFolders = [
  '.vscode', 'misc', ".yarn", 'build', '.git', 'svg', 'icons', 
  'node_modules', ".svelte-kit", "static", 'android', 'src-tauri',
]
...
ignoreFiles = [
  '.env', '.yarnrc.yml', '.prettierignore', 'app.d.ts', 
  "todo.txt", "_path.txt", ".eslint.cjs", ".prettierrc", 'count.py', 
  '.gitignore', 'package-lock.json', 'yarn.lock', 'package.json', 
  'tsconfig.json', '.npmrc', 'global.d.ts', 'svelte.config.js', 
  'tailwind.config.cjs', 'postcss.config.cjs', 'vite.config.ts', 
  'stats.html', '.eslintcache', 'README.md', 'TODO.md', '.eslintrc.cjs', 
  '.deepsource.toml', '.eslintignore', 'capacitor.config.ts', 'object-formatter.ts',
  'additional-svelte-jsx.d.ts', 'uno.config.ts', 'theme-config.ts'
]
